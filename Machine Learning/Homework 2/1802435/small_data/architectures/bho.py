...
class WideResNet(nn.Module):
    ...
    def __init__(self, depth, num_classes, input_channels=3, widen_factor=1, dropRate=0.0, block=BasicBlock):
        ...
        self.conv2 = nn.Conv2d(nChannels[3],nChannels[3], kernel_size=3, stride=1,
                               padding=1, bias=False)
        self.relu0 = nn.ReLU(inplace=True)                       
        self.pool = nn.MaxPool2d(3,3)
        self.bn2 = nn.BatchNorm2d(nChannels[3])
        self.conv3 = nn.Conv2d(nChannels[3],nChannels[3], kernel_size=3, stride=1,
                               padding=1, bias=False)
    ...
    @staticmethod
    def get_classifiers():
        return ['wrn-16-8-bho', 'wrn-16-10-bho', 'wrn-22-8-bho', 'wrn-22-10-bho', 'wrn-28-10-bho', 'wrn-28-12-bho']
    
    @classmethod
    def build_classifier(cls, arch: str, num_classes: int, input_channels: int):
        _, depth, widen_factor, _ = arch.split('-')
